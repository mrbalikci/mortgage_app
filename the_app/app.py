...
def load_mortgage_model():
    ...
    model = keras.models.load_model(f'{relative_model_directory}/model_keras.h5')
...
def get_relative_model_directory():
    ...
    loan_app_position = current_directory_path.find('the_app')
    if loan_app_position < 0:
        path_to_model = 'the_app/static/model'
    else:
